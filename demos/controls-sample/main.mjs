import { dotnet } from "./_framework/dotnet.js?v=46796b0cffbc-20260331194653";

async function installMirageHotReloadHints() {
  try {
    const mirageDom = await import("./_framework/mirage-dom.js?v=46796b0cffbc-20260331194653");
